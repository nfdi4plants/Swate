    ...
    let bounce
        ...
        let updatedState =
...

            {
                currentState with
                    PendingMessages =
                        Map.add id newCounter currentState.PendingMessages
            }
            ...
            if remainingMessages = 0 then
                {
                    currentState with
                        PendingMessages =
                            Map.remove id currentState.PendingMessages
                },
                Cmd.ofMsg appMsg
                ...
                JS.console.warn
                    "Invalid debouncer state: there was no state information for the supplier id"
