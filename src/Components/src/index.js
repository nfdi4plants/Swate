export { default as TermSearch } from './output/Composite/TermSearch/TermSearch.fs.ts';
...
export { Viewer as GitMergeConflictViewer } from './output/Page/GitComparison/GitMergeConflictViewer.fs.ts';
export { Main as GitSidebar } from './output/Page/GitSidebar/GitSidebar.fs.ts';
export { SwateApi } from './output/Api/SwateApi.fs.ts';
export { TIBApi } from './output/Api/TIBApi.fs.ts';
import '../tailwind.css'
