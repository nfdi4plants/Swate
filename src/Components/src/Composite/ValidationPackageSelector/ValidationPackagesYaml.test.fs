module internal Swate.Components.Tests.ValidationPackageSelector.ValidationPackagesYaml

open ARCtrl.ValidationPackages
open ARCtrl.Yaml
open Swate.Components.Composite.ValidationPackageSelector.ValidationPackagesYaml
open Vitest
