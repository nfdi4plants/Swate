        ...
        React.Fragment [
            Html.div [
                ...
                prop.children [
                    ...
                    Html.button [
                        prop.className (if isTermActive then "swt:flex-1 swt:rounded-md swt:border swt:border-info swt:bg-info swt:px-3 swt:py-1 swt:text-white" else "swt:flex-1 swt:rounded-md swt:border swt:border-gray-300 swt:bg-white swt:px-3 swt:py-1 swt:text-gray-700")
                        prop.onClick (fun _ -> 
                    ...
                    Html.button [
                        prop.className (if isUnitizedActive then "swt:flex-1 swt:rounded-md swt:border swt:border-info swt:bg-info swt:px-3 swt:py-1 swt:text-white" else "swt:flex-1 swt:rounded-md swt:border swt:border-gray-300 swt:bg-white swt:px-3 swt:py-1 swt:text-gray-700")
                        prop.onClick (fun _ -> 
                            (annoState |> List.mapi (fun i e ->
            ...
            prop.children [
                Html.div [
                    ...
                    prop.children [
                        ...
                        let input = annoState[a].Search.Body.ToOA() |> Some |> Option.map (fun oa -> oa.ToTerm())
                        Swate.Components.Composite.TermSearch.TermSearch.TermSearch(
                            input,
                            setter,
                            classNames = TermSearchStyle(U2.Case1 "swt:w-full swt:min-w-[14rem]"),
    ...
    static member AnnoBlockwithSwate(annoState: Annotation list, setState: Annotation list -> unit, index: int, highlight: Highlight, setHighlight: Highlight -> unit) =
        ...
        let deleteButton (specIndex: int) =
                    Html.span [
                        ...
                        prop.children [
                            Html.span [
                                Html.i [prop.className "swt:iconify swt:fluent--delete-24-regular swt:size-4"]
                            ]
                        ]
                    ]
        ...
        let closeButton (specIndex: int) =
            Html.div [
                ...
                prop.children [
                    Html.span [
                        Html.i [prop.className "swt:iconify swt:fluent--chevron-left-20-regular swt:size-4"]
                    ]
                ]
            ]
        ...
        let valueInput (specIndex: int)  =
            if annoState[specIndex].Search.Body.isUnitized then
                Html.div [
                    ...
                    prop.children [
                        Html.div [
                            prop.className "swt:flex swt:items-center swt:gap-2 swt:relative swt:rounded-md swt:border swt:border-gray-300 swt:bg-white swt:px-3 swt:py-2"
                            prop.children [
                                Html.input [
            ...
            prop.children [
                if mapOfSameHeight[floor a.Height].Length = 1 && a.IsOpen = false then 
                    ...
                    Html.div [
                        ...
                        prop.children [
                            Html.div [
                                ...
                                prop.children [
                                    Html.span [
                                        prop.className "swt:inline-flex swt:h-6 swt:w-6 swt:items-center swt:justify-center swt:rounded-full swt:bg-secondary swt:px-2 swt:py-0.5 swt:text-xs swt:font-semibold swt:text-white"
                    ...
                    Html.div [
                        ...
                        prop.children [
                            Html.div [
                                prop.className "swt:flex swt:flex-col swt:gap-2 swt:border-3 swt:border-secondary swt:p-2 swt:bg-white"
                                prop.children [
                                    closeButton index
