                ...
                Some(
                    ResizeArray [
                        ...
                        OntologyAnnotation(
                            ...
                            "http://example.com/ontology/functional-programming"
                        )
            ...
            Tags =
                Some(
                    ResizeArray [
                        ...
                        OntologyAnnotation("HomeOffice", "http://example.com/ontology/home-office")
                    ]
                )
            Content =
                            ...
                            prop.onClick (fun _ ->
                                Browser.Dom.window.alert (
                                    sprintf
                                        ...
                                        (note.Tags
                                         |> Option.map (fun tags ->
                                             tags |> Seq.map (fun tag -> tag.NameText) |> String.concat ", "
                                         )
                                         |> Option.defaultValue "")
                                        note.Content
                                )
