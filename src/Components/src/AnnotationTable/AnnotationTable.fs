...
type AnnotationTable =
    ...
    static member private ModalController
        ...
        React.fragment [
            ...
            | Some(ModalTypes.PasteCaseUserInput(PasteCases.AddColumns addColumns, selectHandle)) ->
                    ...
                    onKeydown =
                        (fun (e, selectedCells, activeCell) ->
                            ...
                            | AnnotationTableHelper.KbdShortcutTrigger kbd_CtrlV ->
                                let cellCoordinate = {|x = selectedCells.selectedCellsReducedSet.MinimumElement.x - 1; y = selectedCells.selectedCellsReducedSet.MinimumElement.y - 1|}
