...
module CWLBuilder.Domain.ExpressionToolMutations
...
let setExpressionRequirementField (tool: CWLExpressionToolDescription) (key: string) (fieldKey: string) (value: string) =
...
let setExpressionRequirementDockerField (tool: CWLExpressionToolDescription) (key: string) (fieldKey: string) (value: string) =
...
let setExpressionText (tool: CWLExpressionToolDescription) (expression: string) =
