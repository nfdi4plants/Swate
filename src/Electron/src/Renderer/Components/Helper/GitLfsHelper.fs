...
let runToggleLfsMark (relativePath: string) (markAsLfs: bool) : JS.Promise<Result<unit, string>> =
    promise {
...
let runFreeLocalLfsCopy (relativePath: string) : JS.Promise<Result<unit, string>> =
    promise {
