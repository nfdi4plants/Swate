...
type private Selector =
    ...
    static member Main() =
        ...
        let isLoading =
            match pathSnapshot.Status, recentArcsSnapshot.Status with
            | LoadStatus.Ready, LoadStatus.Ready -> false
            | _ -> true
        ...
        React.Fragment [
            ...
            Swate.Components.Selector.Main(
                ...
                ?currentlyOpenArcPath = pathSnapshot.Value
            )
        ]
