module Renderer.components.TemplateWidget
...
[<RequireQualifiedAccess>]
type private TemplateImportMode =
    | AppendToActiveTable
    | CreateNewTable
    | Skip

module private TemplateDataSource =
...
let private previewColumnValues (column: CompositeColumn) =
    try
                ...
                Html.div [
                    ...
                    prop.children [
                        ...
                        Swate.Components.TemplateFilter.FilteredTemplateRenderer(fun filteredTemplates ->
                            TemplateTable(filteredTemplates, selectedTemplateIds, toggleSelectedTemplate, isLoading, refreshTemplates)
                        )
                    ]
                ]
            )
                                                                                ...
                                                                                Html.div [
                                                                                    ...
                                                                                    prop.children [
                                                                                        for columnIndex in 0 .. columns.Length - 1 do
                                                                                            ...
                                                                                            let previewValues = previewColumnValues columns.[columnIndex]
