...
module ArcRenameHelper =
    ...
    let private tryRenameEntityOnDiskAsync arcPath fileType oldIdentifier newIdentifier (arc: ARC) =
        match fileType with
    ...
    let private renameResolvedArcEntityAsync
        ...
        promise {
                ...
                | Ok targetAbsolutePath ->
                    ...
                    if targetExists then
                        ...
                        | Ok diskArc ->
                            ...
                            | Ok() ->
                                match!
                                    tryRenameEntityOnDiskAsync arcPath fileType oldIdentifier newIdentifier diskArc
                                with
                                | Error errors ->
                                    return
                                        Error(
            ...
            with renameError ->
                ...
                return
                    Error(
                        exn $"Could not rename ARC entity from '{sourcePath}' to '{targetPath}': {mappedError.Message}"
                    )
        }
    ...
    let renameArcEntityAsync
        ...
        promise {
            ...
            let sourceClassification =
                ArcEntityPathRules.classifyRenameTarget requestedRelativePath
