...
type SidebarView =
    ...
    static member Main(model: Model, dispatch: Msg -> unit) =
        Html.div [
            prop.className
                "swt:min-h-full swt:flex swt:flex-col swt:bg-base-300 swt:min-w-125 swt:xl:min-w-150 swt:h-40 swt:overflow-y-auto swt:overflow-x-hidden swt:[scrollbar-gutter:stable] swt:@container/sidebar"
            prop.children [
