...
type BaseNavbar =
    static member Main(children: ReactElement) =
        //Daisy.navbar [
        Html.div [
            prop.className "swt:navbar swt:bg-secondary swt:gap-2"
    ...
    static member Glow(children: ReactElement) =
        ...
        Html.div [
            ...
            prop.children [
                Html.div [
                    prop.className
                        "swt:absolute swt:inset-0 swt:bg-gradient-to-r swt:from-primary swt:to-info swt:blur-2xl swt:opacity-75"
                ]
                Html.div [
