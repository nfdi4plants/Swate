...
type SearchComponent =
    ...
    static member private scrollIntoViewRetry (id: string) =
    ...
    static member private addBuildingBlock (model: Model, state: Model.BuildingBlock.Model, dispatch) =
        ...
        SearchComponent.scrollIntoViewRetry id

    static member private AddBuildingBlockButton (model: Model, dispatch, ?setIsOpen: bool -> unit) =
        let state = model.AddBuildingBlockState
    ...
    [<ReactComponent>]
    static member Main (model: Model, dispatch, ?setIsOpen: bool -> unit) =
        ...
        Html.div [
            Html.form [
                ...
                prop.children [
                    ...
                    SearchComponent.AddBuildingBlockButton(model, dispatch, ?setIsOpen = setIsOpen)
