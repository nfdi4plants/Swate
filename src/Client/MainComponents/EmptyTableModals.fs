...
module EmptyTableModals =
    ...
    type EmptyTableModals =
        ...
        static member BuildingBlock(model, isOpen, setIsOpen, dispatch) =
            let content = SearchComponent.Main(model, dispatch, setIsOpen = setIsOpen)
                        ...
                        Html.div [
                            ...
                            prop.children [
                                Html.table [
                                    ...
                                    prop.children [
                                        Html.caption [
                                            prop.className "swt:text-lg swt:font-semibold swt:pb-2 swt:text-left swt:align-left"
                                            prop.text "Preview: "
                                        ]
                                        Html.thead [
                                            Html.tr [
                ...
                Html.div [
                    ...
                    prop.children [
                        Html.div [
                            ...
                            prop.children [
                                Html.span [
                                    prop.className "swt:join-item swt:btn swt:btn-ghost swt:shadow-none swt:pointer-events-none"
                                    prop.text "Tables:"
                                ]
                                Html.select [
                        ...
                        Html.button [
                            ...
                            prop.onClick (fun _ ->
                                ...
                                Spreadsheet.RemoveTable(activeTableIndex)
