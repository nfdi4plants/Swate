...
module Column =
    ...
    let createHiddenColAttributes (newBB:Types.BuildingBlockTypes.InsertBuildingBlock) (id:int) =
    ...
    let createTANColName (newBB:Types.BuildingBlockTypes.InsertBuildingBlock) (id:int) =
        let bracketAttributes = createHiddenColAttributes newBB id
    ...
    let findNewIdForColumn (allColHeaders:string []) (newBB:Types.BuildingBlockTypes.InsertBuildingBlock) =
