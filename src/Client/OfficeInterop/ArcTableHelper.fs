...
type ArcTable with
    ...
    /// </summary>
    /// <param name="context"></param>
    static member tryGetActiveArcTable (context: RequestContext) : JS.Promise<Result<ArcTable, exn>> =
        promise {
    ...
    /// </summary>
    /// <param name="context"></param>
    static member tryGetPrevArcTable (context: RequestContext) : JS.Promise<ArcTable option> =
        promise {
