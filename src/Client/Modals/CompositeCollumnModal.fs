...
type CompositeCollumnModal =
    ...
    static member modalActivity
        (
            potCell: CompositeCell option,
            modalActivity,
            setModalActivity,
            transFormCell,
            rmv: MouseEvent -> unit,
    ...
    static member Main
        ...
        | Some cell when cell.isData ->
            ...
            let nextCell =
                CompositeCell.createDataFromString ($"{newValue}#{selector}", format, selectorFormat)
