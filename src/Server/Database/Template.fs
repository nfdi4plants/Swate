...
//            printfn "HIT asTemplate"
//            fun record ->
//                let template =
//                    let dbJson = record.["t.templateJson"].As<string>()
//                    printfn "dbJson: %s" dbJson
//                    printfn "STEP1: %A" (dbJson |> rowMajorOfTemplateJson)
...
//                    credentials
//                )
//            printfn "LENGTH: %i " <| (Seq.length dbResults)
//            printfn "Hit 3!"
