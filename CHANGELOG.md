...
-   Show a clear error with the selected folder path when opening a folder that is not a valid ARC in the Electron app, and display blocking progress feedback while the selected folder is being checked.
