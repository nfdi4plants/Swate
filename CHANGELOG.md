...
-   Added CWL editor domain logic (ported from CWLBuilder) with .NET test suite tests/Cwl, built on immutable reducer-driven state with an async-safe effect runner and Storybook interaction coverage.
